...
class QuintupleInvertedPendulumEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.m_c = 1.0
        self.m = np.array([0.5]*5)
        self.l = np.array([0.5]*5)
        self.g = 9.81
        ...
        high = np.ones(12, dtype=np.float32) * np.inf
    ...
    def reset(self, seed=None, options=None):
        ...
        self.state = self.np_random.uniform(-0.05, 0.05, size=(12,))
        return self.state.astype(np.float32), {}

    def _get_dynamics(self, state, force):
        x, t1, t2, t3, t4, t5, xd, t1d, t2d, t3d, t4d, t5d = state
